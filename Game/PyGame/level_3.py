from support import *
import const as c
from Tiles import (Tile, StatictTile, Lucky_block, Coin, Cloud, Fungus_red,
                   Big_castle)
...
class Level_3:
        ...
        for row_index, row in enumerate(layout):
            for col_index, val in enumerate(row):
                if val != '-1':
                    ...
                    if type_ == 'platforms':
                        platforms_tile_list = import_cut_graphics('../pics/platforms_3.png')
    ...
    def hor_move_coll(self):
        ...
        coliable_sprites = (self.platform_sprites.sprites() + self.lucky_blocks_sprites.sprites() +
                            self.uppers_sprites.sprites())
